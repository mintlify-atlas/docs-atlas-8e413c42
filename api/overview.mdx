---
title: "InnovaTech SOA REST API Overview"
sidebarTitle: "Overview"
description: "All InnovaTech SOA REST APIs are exposed through a centralized Spring Cloud Gateway on port 8080. Learn the base URL, routing structure, and available service namespaces."
---
...
Each microservice generates its own interactive Swagger UI automatically via SpringDoc OpenAPI. You can explore and test endpoints directly in the browser at the service's native port — no authentication required during local development.

| Service | Swagger UI URL | OpenAPI JSON |
|---|---|---|
| servicio-catalogo | http://localhost:8084/swagger-ui.html | http://localhost:8084/api-docs |
| servicio-inventario | http://localhost:8081/swagger-ui.html | — |

<Note>
  Swagger UI is available on the service's direct port, not through the gateway. This is intentional — the Swagger UI URLs are development tools and are not routed through port 8080.
</Note>
