---
title: "Catalog Service API: MongoDB Product Management"
sidebarTitle: "Catalog API"
description: "The Catalog Service API manages product and pricing data stored in MongoDB, accessible via the API Gateway at /api/v1/catalogo/**. Explore endpoints via Swagger UI."
---
