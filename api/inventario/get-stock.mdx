---
title: "GET Inventory Stock by Product ID — InnovaTech API"
sidebarTitle: "GET Stock"
description: "Retrieve the current stock count for a product by ID. Returns a plain integer via GET /api/v1/inventario/{productoId}/stock, or 0 if not found."
---
