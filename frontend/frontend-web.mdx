...
description: "The frontend-web app is a React 19 + Vite single-page application serving the digital e-commerce channel, connecting to InnovaTech SOA through the API Gateway."
---
...
| @types/react | 19.2 | TypeScript type definitions |
| @types/react-dom | 19.2 | TypeScript type definitions for DOM |
