...
description: "The frontend-pos app is a React 19 + Vite single-page application powering in-store point-of-sale terminals, integrated with the POS sales orchestrator via the API Gateway."
---
