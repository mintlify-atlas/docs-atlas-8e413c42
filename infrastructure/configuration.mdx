...
description: "Reference for all InnovaTech SOA microservice configs: port allocations, database URLs, Eureka registration, gateway routes, and SpringDoc API doc paths."
---
